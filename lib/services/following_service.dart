  ...
  Future<List<StoreUpdateModel>> getFeed({
    ...
    try {
      ...
      return snapshot.docs.map((doc) {
        return StoreUpdateModel.fromMap(
    ...
    try {
      ...
      if (isCurrentlyFollowing) {
        ...
        if (storeData['ownerId'] != null &&
            storeData['ownerId'].toString().isNotEmpty) {
          batch.set(notifRef, {
            ...
            'title': 'New Follower',
            'message':
                '${user.displayName ?? 'A customer'} started following your store',
            'referenceId': storeId,
            'isRead': false,

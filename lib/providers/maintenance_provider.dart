...
class MaintenanceProvider extends ChangeNotifier {
  ...
  String _message =
      'FreshGa HomeMades is currently undergoing scheduled maintenance to serve you better. We\'ll be back soon!';
  String _endTime = '';
    ...
    _subscription = FirebaseFirestore.instance
        ...
        .listen(
          (doc) {
            if (doc.exists) {
              final data = doc.data()!;
              final active = data['customer_maintenance_mode'] ?? false;
          ...
          onError: (e) {
            // Ignore permission errors if user is logged out, etc.
          },
        );
  }

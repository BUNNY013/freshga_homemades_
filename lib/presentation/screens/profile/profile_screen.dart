...
class ProfileScreen extends StatelessWidget {
            ...
            (
              ...
              return StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, ordersSnap) {
                  final ordersCount = ordersSnap.hasData
                      ? ordersSnap.data!.docs.length
                      : 0;
                      ...
                      children: [
                        ...
                        _buildSectionCard([
                          _buildMenuTile(
                            ...
                            subtitle:
                                'Track active orders and reorder homemade favorites',
                            onTap: () {
                              CustomerHomeScreen.globalKey.currentState
                                  ?.switchTab(3);
                            },
                          ),
                          ...
                          _buildMenuTile(
                            ...
                            subtitle:
                                '$followingCount followed homemade store(s)',
                            onTap: () {
                              CustomerHomeScreen.globalKey.currentState
                                  ?.switchTab(2);
                            },
                          ...
                          _buildMenuTile(
                            ...
                            subtitle:
                                '$wishlistCount homemade specialty(ies) saved',
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        _buildSectionCard([
                          _buildMenuTile(
                            ...
                            subtitle:
                                'View your submitted queries and resolutions',
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const CustomerTicketsScreen(),
                                ),
                              );
                            },
                          ),
                          ...
                          _buildMenuTile(
                            ...
                            title: 'Help & Support',
                            subtitle:
                                'Frequently asked questions & WhatsApp support',
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                          ...
                          _buildMenuTile(
                            ...
                            subtitle:
                                'FSSAI compliance, Terms of Service & Privacy Policy',
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () =>
                              _showEditProfileModal(context, name, email),
                          child: Container(
  ...
  void _showEditProfileModal(
    ...
    final nameCtrl = TextEditingController(
      text: initialName == 'Taste Explorer' ? '' : initialName,
    );
    final emailCtrl = TextEditingController(
      text: initialEmail == 'Not set' ? '' : initialEmail,
    );
  ...
  void _showLogoutConfirm(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to sign out of your FreshGa account?'.tr(),
        ),
        actions: [
          TextButton(
  ...
  void _showDeleteConfirm(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'This action is irreversible. All saved delivery addresses, following preferences, and order history associated with your number will be permanently deleted.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                trailing: context.locale.languageCode == 'te'
                    ? const Icon(Icons.check, color: AppColors.primaryGreen)
                    : null,
                onTap: () {

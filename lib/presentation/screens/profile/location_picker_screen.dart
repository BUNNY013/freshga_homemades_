...
class _LocationPickerScreenState extends State<LocationPickerScreen> {
    ...
    _searchDebounce = Timer(const Duration(milliseconds: 800), () async {
      ...
      try {
        ...
        final response = await http.get(
          url,
          headers: {'User-Agent': 'com.freshga.homemades/1.0'},
        );
  ...
  void initState() {
    ...
    if (widget.initialLat != null) {
      ...
      // Auto fetch current location if no initial lat/lng provided
          ...
          FlutterMap(
            ...
            children: [
              TileLayer(
                ...
                userAgentPackageName: 'com.freshga.homemades',
                retinaMode:
                    true, // Enables high-res tiles for crisp road/place names
              ),
            ],
          ),
          ...
          const Center(
            child: Padding(
              padding: EdgeInsets.only(
                bottom: 40.0,
              ), // Offset to align point of pin with center
              child: Icon(
                Icons.location_on,
                size: 48,
                    ...
                    child: _isSearching
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final subName = nameParts.length > 1
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Drag the map to place the green pin exactly on your delivery location for accurate delivery.",
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed:
                          ...
                          ? null
                          : () {
                              // Return both center and placemark if available

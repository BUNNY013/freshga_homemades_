...
class OrderHelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isNew = order.orderStatus == 'New' || order.orderStatus == 'Accepted';
    final bool isProcessing = order.orderStatus == 'Packed' || order.orderStatus == 'Shipped';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("What do you need help with?", style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18, color: AppColors.textPrimary)),
                  ...
                  if (isNew) ...[
                    _buildTopicTile(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => CancelOrderScreen(order: order)));
                      },
                    ),
                    _buildTopicTile(
                      context,
                      ...
                      onTap: () => _showQueryForm(context, "Update Instructions"),
                    ),
                  ],
                  ...
                  const SizedBox(height: 24),
                  const Text("Other Queries", style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: AppColors.textPrimary)),
  ...
  Widget _buildContextCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.primaryGreen.withOpacity(0.04), blurRadius: 20, offset: const Offset(0, 4))],
      ),
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.receipt_outlined, color: AppColors.primaryGreen),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(order.storeName, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 4),
                Text("Order ID: ${order.orderId}", style: TextStyle(color: Colors.grey.shade600, fontSize: 13, fontWeight: FontWeight.w500)),
                const SizedBox(height: 4),
                Text(DateFormat('dd MMM, hh:mm a').format(order.createdAt), style: TextStyle(color: Colors.grey.shade500, fontSize: 12)),
              ],
            ),
          ),
          Container(
  ...
  Widget _buildTopicTile(BuildContext context, {required IconData icon, required String title, required String subtitle, required VoidCallback onTap}) {
    return Container(
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text("Submit a Query", style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
                        IconButton(
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Topic: $topic", style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: AppColors.primaryGreen)),
                        const SizedBox(height: 16),
                        const Text("Please describe your issue in detail. Our support team will get back to you soon.", style: TextStyle(color: Colors.black87, fontSize: 14)),
                        const SizedBox(height: 16),
                        TextField(

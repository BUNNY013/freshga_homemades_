              ...
              ClipRRect(
                ...
                child: product.imageUrl.isNotEmpty
                    ? CachedNetworkImage(
                        ...
                        fit: BoxFit.cover,
                        placeholder: (context, url) => const ShimmerLoading(width: double.infinity, height: 120),
                        errorWidget: (context, url, error) => Container(color: Colors.grey.shade200, height: 120),
                      )
                    : Container(
                        height: 120,
                        width: double.infinity,
                ...
                Row(
                  children: [
                    ...
                    if (product.weight.isNotEmpty) ...[
                      ...
                      Text(product.weight, style: const TextStyle(fontSize: 10, color: AppColors.textSecondary)),
                    ]
                  ],
                ),
